...
import com.example.password.utils.CustomSwitch
...
fun AddUtils(){
    ...
    Scaffold(topBar = { TopAppBar(title = { Text(text = "Anasayfa") }) }) { paddingValues ->
        Column(
            ...
            Image(painter = painterResource(id = R.drawable.password_invalid), contentDescription = "")
            ...
            Box{
                Row(
                    ...
                    Image(painter = painterResource(id = R.drawable.password_invalid),
                        contentDescription = "")
                }
